...
function animateOpen(){
    ...
    menuBtn.classList.remove("disMenu")
    menuBtn.classList.add("noDis")
    companyLogo.classList.add("noDis")
...
function animateClose(){
    ...
    menuBtn.classList.add("disMenu")
    companyLogo.classList.remove("noDis")
...
totalAmount = 0
    ...
    switch(true){
        case totalCourseCount ==  0:
            ...
            var errMsg= document.querySelector("#errorCheck")
            errMsg.style.display = 'block';
            errMsg.style.color = "red";
            errMsg.textContent="Please select a course"
            setTimeout(function(){errMsg.style.display = 'none'}, 3000)
            return false;
            break;
